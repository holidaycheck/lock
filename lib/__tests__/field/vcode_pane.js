...
jest.mock('ui/input/vcode_input', function () {
  return mockComponent('vcode_input');
});
...
describe('VcodePane', function () {
  ...
  it('renders correctly', function () {
    ...
    expectComponent(React.createElement(VcodePane, defaultProps)).toMatchSnapshot();
  });
  it('shows header when instructions are available', function () {
    var VcodePane = getComponent();

    expectComponent(React.createElement(VcodePane, _extends({}, defaultProps, {
  ...
  it('calls `onRestart` when alternative link is clicked', function () {
    ...
    var wrapper = mount(React.createElement(VcodePane, defaultProps));
