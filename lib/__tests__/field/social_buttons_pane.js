...
jest.mock('ui/button/auth_button', function () {
  return mockComponent('auth_button');
});
...
describe('SocialButtonsPane', function () {
  ...
  it('renders correctly', function () {
    ...
    expectComponent(React.createElement(SocialButtonsPane, defaultProps)).toMatchSnapshot();
  });
  it('renders big buttons when bigButtons === true', function () {
    var SocialButtonsPane = getComponent();
    expectComponent(React.createElement(SocialButtonsPane, _extends({}, defaultProps, {
      bigButtons: true
    }))).toMatchSnapshot();
  });
  ...
  it('calls `logIn` with social connection 1 when first button is clicked', function () {
    ...
    var wrapper = mount(React.createElement(SocialButtonsPane, defaultProps));
  ...
  it('calls `logIn` with social connection 2 when second button is clicked', function () {
    ...
    var wrapper = mount(React.createElement(SocialButtonsPane, defaultProps));
    var props = extractPropsFromWrapper(wrapper, 3);
