...
jest.mock('ui/input/email_input', function () {
  return mockComponent('email_input');
});
...
describe('EmailPane', function () {
  ...
  beforeEach(function () {
    ...
    var mockEmailField = Immutable.fromJS({
      value: mockEmail
    });
  ...
  it('renders correctly', function () {
    ...
    expectComponent(React.createElement(EmailPane, defaultProps)).toMatchSnapshot();
  });
  ...
  it('fetches the avatar on componentDidMount if ui.avatar is true and there is a username', function () {
    ...
    mount(React.createElement(EmailPane, defaultProps));
  ...
  it('fetches the avatar onChange if ui.avatar is true', function () {
    ...
    var wrapper = mount(React.createElement(EmailPane, defaultProps));
