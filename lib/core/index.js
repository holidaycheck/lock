...
function extractUIOptions(id, options) {
  ...
  var hideMainScreenTitle = theme.hideMainScreenTitle;
  var logo = theme.logo;
  var primaryColor = theme.primaryColor;
  var authButtons = theme.authButtons;
...
var getUI = _dataFns3.get;
var setUI = _dataFns3.set;

var _dataFns4 = (0, _data_utils.dataFns)(["core", "transient", "ui"]);

var tgetUI = _dataFns4.get;
var tsetUI = _dataFns4.set;
...
var getAuthAttribute = _dataFns5.get;
...
function extractAuthOptions(options) {
  ...
  var connectionScopes = _ref.connectionScopes;
  var params = _ref.params;
  var autoParseHash = _ref.autoParseHash;
