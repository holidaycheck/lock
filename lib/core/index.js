...
var _dataFns2 = (0, _data_utils.dataFns)(['social']), tsetSocial = _dataFns2.tset;
...
function extractUIOptions(id, options) {
  ...
  return new _immutable2.default.fromJS({
    ...
    authButtonsTheme: (typeof authButtons === 'undefined' ? 'undefined' : _typeof(authButtons)) ===
      'object'
      ? authButtons
      : {}
  });
...
var _dataFns5 = (0, _data_utils.dataFns)(['core', 'auth']), getAuthAttribute = _dataFns5.get;
...
function extractAuthOptions(options) {
  ...
  connectionScopes = (typeof connectionScopes === 'undefined'
    ? 'undefined'
    : _typeof(connectionScopes)) === 'object'
    ? connectionScopes
    : {};
  params = (typeof params === 'undefined' ? 'undefined' : _typeof(params)) === 'object'
    ? params
    : {};
