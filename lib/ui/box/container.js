...
var badgeSvg = React.createElement(
  'svg',
...
var Avatar = function Avatar(_ref2) {
  ...
  return React.createElement('img', { src: imageUrl, className: 'auth0-lock-header-avatar' });
};
...
var Container = function (_React$Component) {
  ...
  Container.prototype.render = function render() {
    ...
    var badge = showBadge ? React.createElement(BottomBadge, { link: badgeLink }) : null;

    var overlay = isModal ? React.createElement(
      'div',
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          closeHandler && React.createElement(CloseButton, { onClick: this.handleClose.bind(this) }),
          React.createElement(
            'div',
...
export var defaultProps = Container.defaultProps = {
  autofocus: false,
