...
var WelcomeMessage = (function(_React$Component3) {
  ...
  WelcomeMessage.prototype.render = function render() {
    var _props3 = this.props, name = _props3.name, title = _props3.title;

    var className = void 0, message = void 0;
    ...
    return _react2.default.createElement('div', { className: className }, message);
  };
