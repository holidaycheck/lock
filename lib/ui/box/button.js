...
export var CloseButton = function CloseButton(_ref2) {
  ...
  return React.createElement(IconButton, { name: 'close', svg: svgs["close"], onClick: onClick });
};
...
export var BackButton = function BackButton(_ref3) {
  var onClick = _ref3.onClick;
  return React.createElement(IconButton, { name: 'back', svg: svgs["back"], onClick: onClick });
};
