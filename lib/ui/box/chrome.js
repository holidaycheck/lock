...
var SubmitButton = function (_React$Component) {
  ...
  SubmitButton.prototype.render = function render() {
    ...
    var content = label ? React.createElement(
      'span',
      { className: 'auth0-label-submit' },
      label,
      React.createElement('span', { dangerouslySetInnerHTML: { __html: submitText } })
    ) : React.createElement('span', { dangerouslySetInnerHTML: { __html: submitSvg } });
...
var Chrome = function (_React$Component2) {
  ...
  Chrome.prototype.focusError = function focusError() {
    var node = ReactDOM.findDOMNode(this.refs.screen);
  ...
  Chrome.prototype.render = function render() {
    ...
    var submitButton = showSubmitButton && !delayingShowSubmitButton && React.createElement(SubmitButton, {
      color: primaryColor,
    ...
    var globalError = error ? React.createElement(GlobalMessage, { key: 'global-error', message: error, type: 'error' }) : null;
    var globalSuccess = success ? React.createElement(GlobalMessage, { key: 'global-success', message: success, type: 'success' }) : null;
    ...
    return React.createElement(
      'div',
      { className: className },
      React.createElement(Header, { title: title, name: name, backHandler: backHandler && this.handleBack.bind(this), backgroundUrl: backgroundUrl, backgroundColor: primaryColor, logoUrl: logo }),
      React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement(Content, _extends({ focusSubmit: this.focusSubmit.bind(this) }, contentProps))
                  )
                ),
                terms && React.createElement(
                  'small',
