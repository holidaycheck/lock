...
var Chrome = function (_React$Component2) {
  ...
  Chrome.prototype.render = function render() {
    ...
    var globalError = error ? _react2.default.createElement(_global_message2.default, { key: 'global-error', message: wrapGlobalMessage(error), type: 'error' }) : null;
    var globalSuccess = success ? _react2.default.createElement(_global_message2.default, { key: 'global-success', message: wrapGlobalMessage(success), type: 'success' }) : null;
