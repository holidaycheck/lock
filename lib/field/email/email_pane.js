...
var EmailPane = function (_React$Component) {
  ...
  EmailPane.prototype.render = function render() {
    ...
    var _props$forceInvalidVi = _props.forceInvalidVisibility;
    var forceInvalidVisibility = _props$forceInvalidVi === undefined ? false : _props$forceInvalidVi;


    var field = c.getField(lock, "email");
    var value = field.get('value', "");
    var valid = field.get('valid', true);
    var invalidHint = field.get('invalidHint', i18n.str(value ? "invalidErrorHintEmail" : "blankErrorHintEmail"));
