...
function processDatabaseOptions(opts) {
  ...
  var initialScreen = _processScreenOptions.initialScreen;
  var screens = _processScreenOptions.screens;
...
function overrideDatabaseOptions(m, opts) {
  ...
  var initialScreen = _processScreenOptions2.initialScreen;
  var screens = _processScreenOptions2.screens;
...
function hasScreen(m, s) {
  ...
  var allowForgot = _toJS.allowForgot;
  var allowSignup = _toJS.allowSignup;
